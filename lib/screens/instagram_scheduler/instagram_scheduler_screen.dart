...
class InstagramSchedulerScreen extends ConsumerStatefulWidget {
  const InstagramSchedulerScreen({super.key});

  @override
  ConsumerState<InstagramSchedulerScreen> createState() =>
      _InstagramSchedulerScreenState();
}

class _InstagramSchedulerScreenState
    extends ConsumerState<InstagramSchedulerScreen> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() {
  ...
  List<PostModel> _filterPosts(List<PostModel> posts) {
    return posts
        .where((p) => p.platform == 'instagram' || p.platform == 'both')
        .toList();
  }
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'No Instagram posts scheduled',
            style: Theme.of(context).textTheme.titleMedium,
          ),
          const SizedBox(height: 8),
          Text(
            'Create a post and schedule it for Instagram.',
